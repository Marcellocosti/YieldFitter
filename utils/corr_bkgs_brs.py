final_states = {
    ...
    "DstarD0ToPiKPi": {
      "flag_mc_match_rec": 10,
      "br_sim": 2.0e-1,
      "br_pdg": 3.945e-2,
    },
    "DstarD0ToPiKPiPi0": {
      "flag_mc_match_rec": 11,
      "br_sim": 2.0e-1,
      "br_pdg": 1.44e-1,
    },
    "DstarD0ToPiKK": {
      "flag_mc_match_rec": 13,
      "br_sim": 2.0e-1,
      "br_pdg": 4.08e-3,
    },
    "DstarD0ToPiPiPi": {
      "flag_mc_match_rec": 15,
      "br_sim": 2.0e-1,
      "br_pdg": 1.453e-3,
    },
    "DstarD0ToPiPiPiPi0": {
      "flag_mc_match_rec": 16,
      "br_sim": 2.0e-1,
      "br_pdg": 1.49e-2,
    }
}
    # "LcToPKPi": {
    #   "flag_mc_match_rec": 17,
    #   "br_sim":
    #   "br_pdg":
    # },
    # "LcToPKPiPi0": {
    #   "flag_mc_match_rec": 18,
    #   "br_sim":
    #   "br_pdg":
    # },
    # "LcToPPiPi": {
    #   "flag_mc_match_rec": 19,
    #   "br_sim":
    #   "br_pdg":
    # },
    # "LcToPKK": {
    #   "flag_mc_match_rec": 20,
    #   "br_sim":
    #   "br_pdg":
    # },
    # "XicToPKPi": {
    #   "flag_mc_match_rec": 21,
    #   "br_sim":
    #   "br_pdg":
    # },
    # "XicToPKK": {
    #   "flag_mc_match_rec": 22,
    #   "br_sim":
    #   "br_pdg":
    # },
    # "XicToSPiPi": {
    #   "flag_mc_match_rec"": 23,
    #   "br_mc"':
    #   "br_pdg"':
    # },
